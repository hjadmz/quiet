...
| 13 | Page weight within budget | **pass** | kitchen-sink post: HTML ~13 KB + CSS 14.9 KB + copy.js 1.0 KB ≈ 29 KB excluding content images (budget ≤ 60 KB). CSS 15,254 B unminified (≤ 16 KB); theme script 600 B (≤ 600 B); copy.js 1,019 B (≤ 1 KB); total JS 1,619 B (≤ 2 KB). Re-measure this row whenever the CSS changes. |
